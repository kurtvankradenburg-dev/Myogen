...
BRACHIALIS:
The brachialis is a pure elbow flexor with no supination function, lying deep to the biceps. When well-developed it pushes the biceps upward, contributing to arm width. It is best trained with neutral grip (hammer curl) or pronated grip (reverse curl). The brachialis is always active during any elbow flexion regardless of forearm position — it cannot be suppressed, only emphasised.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
EXERCISE SELECTION — BIOMECHANICAL RATIONALE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

STABILITY HIERARCHY FOR HYPERTROPHY: For maximising motor unit recruitment in the target muscle, prioritise in this order: 1. Machine (selectorised) — most stable, highest target motor unit recruitment. 2. Cable — constant tension through range, adjustable angle, stable enough for isolation. 3. Barbell — high load capacity, less stable. 4. Dumbbell — least stable, lower effective load on target muscle due to stabiliser demand. Use cables and machines for hypertrophy-focused isolation. Use free weights for compound strength development.

CHEST-SUPPORT RULE: Any shrug, row, or fly should be chest-supported (bench or pad) when the goal is target muscle hypertrophy. Without chest support in bent-over rows or shrugs, erector spinae, glutes, and hamstrings must statically stabilise the torso — this is a competing motor unit demand that steals recruitment from the target muscle. Chest support eliminates this, freeing more motor unit recruitment for the target.

RESISTANCE CURVES: Dumbbells follow a sinusoidal resistance curve — peak load at 90° of the movement, near-zero at the ends — and critically miss the lengthened position. Cables provide constant tension throughout the range and can be set to maximally load any point including the lengthened position where mechanotransduction is greatest. Quality cam-based machines engineer the resistance curve to load the lengthened position. For hypertrophy isolation work, cables and machines are superior to dumbbells because they load the position that matters most.

ELBOW CUFF PRINCIPLE: Standard grip exercises create a 3-joint action — wrist (forearm flexors), elbow (biceps), and shoulder (target muscle). Forearms or biceps often fatigue before the target muscle is maximally stimulated. An elbow cuff attachment bypasses the wrist entirely and reduces biceps as a prime mover, creating a 2-joint action where the shoulder joint's prime mover (lat, delt, or pec) receives maximal motor unit demand. Apply to: straight-arm pull-downs, cable rows, cable front raises, lat pull-downs (kneel flaps).
