...
TUT refers to the total duration a muscle remains under load per set, with the optimal hypertrophy range being approximately 30–70 seconds. The eccentric phase at 3–5 seconds produces the greatest mechanical tension and muscle damage — the most potent phase biomechanically for hypertrophy. The concentric phase at 1–2 seconds preserves motor unit recruitment rate. Longer TUT increases metabolic stress through lactate accumulation and cell swelling as well as growth factor release. Rep tempo is notated as eccentric:iso-hold:concentric:top-hold (e.g., 4-1-2-0). Do not recommend artificially slow reps unless specifically programmed. Excessive momentum should always be avoided and controlled execution is the default for all exercises.
